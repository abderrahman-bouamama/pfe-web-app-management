                    ...
                    <form>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    type="text"
                                    className="w-full border bg-yellow-100 border-gray-200 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
                            ...
                            <div>
                                ...
                                <input
                                    type="email"
                                    className="w-full border bg-yellow-100 border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
